...
#define	E2BIG			1		/* Argument list too long or Lack of space
 * in an output buffer or Argument is greater than the system-imposed maximum */
...
#define	EINPROGRESS		26		/* Operation in progress or O_NONBLOCK is
 * set for the socket file descriptor and the connection cannot be
...
#define	EMFILE			33		/* File descriptor value too large or too
 * many open streams */
#define	EMLINK			34		/* Too many links */
#define	EMSGSIZE		35		/* Message too large or Inappropriate
